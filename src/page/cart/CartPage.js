...
const CartPage = () => {
  ...
  return (
    <>
      <section className="container-section mx-auto flex-grow  border-b py-5 lg:flex lg:flex-row lg:py-10">
        <MobileCart
        ...
        <section className="mx-auto w-full px-4 md:max-w-[400px]">
          <div className="">
            <div className="border py-5 px-4 shadow-md">
              ...
              <Link >
                <button className="w-full bg-violet-900 px-5 py-2 text-white  rounded-md" onClick={()=>navigate("/checkout")}>
                  Proceed to checkout
                </button>
              </Link>
            </div>
