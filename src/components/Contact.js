            ...
            <ul className="mt-5">
                ...
                <li className="flex items-center mb-5">
                    ...
                    <div>
                        ...
                        <p><a href="" className="hover:text-lime-300">+48-500-130-0001</a></p>
                        <p><a href="" className="hover:text-lime-300">+48-500-130-0001</a></p>
                    </div>
                </li>
                <li className="flex items-center mb-5 ">
                    ...
                    <div>
                        ...
                        <p><Link className="hover:text-lime-300">info1@gmail.com</Link></p>
                    </div>
                </li>
            </ul>
          </div>
          <div className="lg:col-span-6 md:col-span-6 sm:col-span-12 ">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d55559613.167613834!2d4.028919!3d31.795306000000004!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604b900d26973%3A0x4291f3172409ea92!2slastminute.com%20London%20Eye!5e0!3m2!1sen!2sus!4v1715889186038!5m2!1sen!2sus" className="w-[100%]" height={450} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />

          </div>
        </div>
      </div>
      <div className="bg-white mat-50 mb-20">
