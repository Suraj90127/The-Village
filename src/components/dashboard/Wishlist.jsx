...
const Wishlist = () => {
  ...
  const wishlist = [{ discount: 20, image: "https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500", name: "wwww", price: 20 }];
  return (
        ...
        >
          ...
          <div className="py-3 text-slate-600 px-2">
            ...
            <div className="flex justify-start items-center gap-3">
              ...
              <div className="flex">{/* <Ratings ratings={4.5} /> */}</div>
            </div>
          </div>
        </div>
      ))}
